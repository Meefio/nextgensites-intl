      ...
      process.env.NODE_ENV === 'production'
        ? {
          ...
          value: [
            ...
            "img-src 'self' blob: data: https://*.googletagmanager.com https://*.google-analytics.com https://*.g.doubleclick.net https://cdn.jsdelivr.net https://*.googlesyndication.com https://cdn.sanity.io",
