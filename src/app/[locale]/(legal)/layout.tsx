...
export default function LegalLayout({
  ...
  return (
    <>
      {/* Dodajemy Schema.org JSON-LD */}
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(legalPagesSchema) }}
      />
        ...
        <div className="container flex h-16 items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            <svg fill="none" viewBox="0 0 238 238" className="size-6 text-primary" role="img"
              aria-labelledby="legal-logo-title">
              <title id="legal-logo-title">Logo NextGen Sites</title>
              <path
