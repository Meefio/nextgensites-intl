...
// Create a factory function that accepts locale
export const createMDXComponents = (locale: string) => {
...
// Export the original MDXComponents for backward compatibility
export const MDXComponents = createMDXComponents('pl'); // Default to Polish
